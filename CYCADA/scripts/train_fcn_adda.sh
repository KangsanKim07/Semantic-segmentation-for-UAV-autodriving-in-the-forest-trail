...
src='cyclegta5'
tgt='cityscapes'
datadir='/home/pun/URP/Segmentation/cycada_release-master/dataset'


resdir="/home/pun/URP/Segmentation/cycada_release-master/results/${src}_to_${tgt}/adda_sgd/${weight_share}_nolsgan_${discrim}"
